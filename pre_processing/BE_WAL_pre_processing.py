...
def main():
    ...
    in_dir = os.path.join("data", "vector", "IACS", "BE", "WAL", "Original")
    ...
    for i, iacs_pth in enumerate(iacs_files):
        ...
        out_pth = os.path.join("data", "vector", "IACS", "BE", "WAL", f"GSA-BE_WAL-{year}.geoparquet")
        ...
        # iacs_sub.to_file(os.path.join("data", "vector", "IACS", "BE", "WAL", f"SUB-GSA-BE_WAL-{year}.gpkg"), driver="GPKG)
